...
if test -f /Users/byodian/miniconda3/bin/conda
    eval /Users/byodian/miniconda3/bin/conda "shell.fish" "hook" $argv | source
else
    if test -f "/Users/byodian/miniconda3/etc/fish/conf.d/conda.fish"
        . "/Users/byodian/miniconda3/etc/fish/conf.d/conda.fish"
    else
        set -x PATH "/Users/byodian/miniconda3/bin" $PATH
    end
end
# <<< conda initialize <<<
